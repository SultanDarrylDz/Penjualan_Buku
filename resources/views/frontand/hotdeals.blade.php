					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="asset/img/1.jpg" height="100px" width="200px" alt="">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
					...
					<div id="store" class="col-md-9">
						...
						<div class="row">
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="asset/img/8334101540_f.jpg" height="250px" alt="">
										<div class="product-label">
											<span class="new">NEW</span>
										</div>
									</div>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="asset/img/dear-nathan.jpg" height="250px" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Romanc</p>
										<h3 class="product-name"><a href="#">Dear Nathan</a></h3>
										<h4 class="product-price">Rp 52.000 <del class="product-old-price">Rp 100.000</del></h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="asset/img/sijuki.jpg" height="250px" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Komedi</p>
										<h3 class="product-name"><a href="#">Si Juki</a></h3>
										<h4 class="product-price">Rp 33.000 <del class="product-old-price">Rp 40.000</del></h4>
										<div class="product-rating">
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
											<i class="fa fa-star"></i>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="asset/img/3.jpg" height="250px" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Horror</p>
										<h3 class="product-name"><a href="#">Ghotbuster</a></h3>
										<h4 class="product-price">Rp 43.000 <del class="product-old-price">Rp 50.000</del></h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
							...
							<div class="col-md-4 col-xs-6">
								<div class="product">
									<div class="product-img">
										<img src="asset/img/101199_f.jpg" height="250px" alt="">
									</div>
									<div class="product-body">
										<p class="product-category">Fiksi</p>
										<h3 class="product-name"><a href="#">Malaikat Jatuh</a></h3>
										<h4 class="product-price">Rp 15.000 <del class="product-old-price">Rp 20.000</del></h4>
										<div class="product-rating">
										</div>
										<div class="product-btns">
											<button class="add-to-wishlist"><i class="fa fa-heart-o"></i><span class="tooltipp">add to wishlist</span></button>
