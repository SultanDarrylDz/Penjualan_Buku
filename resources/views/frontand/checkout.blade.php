				...
				<div class="row">
					...
					<div class="col-md-7">
						...
						<div class="billing-details">
							...
							<div class="form-group">
								<input class="input" type="text" name="Masukan Nama" placeholder="Masukan Nama">
							</div>
							<div class="form-group">
								<input class="input" type="text" name="Alamat" placeholder="Alamat">
							</div>
							<div class="form-group">
								<input class="input" type="number" name="No Handphone" placeholder="No Handphone">
							</div>
							<div class="form-group">
								<input class="input" type="date" name="Tanggal Beli" placeholder="Tanggal Beli">
							</div>
							<div class="form-group">
					...
					<div class="col-md-5 order-details">
						...
						<div class="order-summary">
							...
							<div class="order-col">
								<div><strong>TOTAL</strong></div>
								<div><strong class="order-total">Rp 22.000</strong></div>
							</div>
						</div>
						<div class="payment-method">
							<div class="input-radio">
								...
								<div class="caption">
									<p>Anda memilih pembayaran menggunakan via Bank Transfer</p>
								</div>
							</div>
							<div class="input-radio">
						...
						<a href="{{route('finish')}}" class="primary-btn order-submit">Place order</a>
					</div>
					<!-- /Order Details -->
				</div>
				<!-- /row -->
