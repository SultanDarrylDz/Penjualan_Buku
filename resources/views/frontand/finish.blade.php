    ...
    <body>
					...
					<div class="row">
						...
						<div class="col-md-3">
							<div class="header-logo">
								<a href="#" class="logo">
									<img src="asset/img/1.jpg" width="150px" height="100px" alt="">
								</a>
							</div>
						</div>
						<!-- /LOGO -->
		...
		<div id="breadcrumb" class="section">
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-md-12">
						<h3 class="breadcrumb-header">Last Page</h3>
		...
		<!-- /BREADCRUMB -->
<p>
     <h5 class="breadcrumb-header">Selamat Pemesanan Berhasil Tunggu Buku Sampai Ke Tujuan</h5>
</p>
		<!-- SECTION -->
		<div class="section">
			<!-- container -->
